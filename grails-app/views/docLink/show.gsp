...
<html>
    ...
    <body>
        ...
        <div id="show-docLink" class="content scaffold-show" role="main">
            ...
            <f:display bean="docLink" />
            <g:form resource="${this.docLink}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.docLink}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
